...
import co.edu.uniandes.csw.eventos.resources.PatrocinadorResource;
...
public class PatrocinadorIT {
    ...
    private static final String COLLECTION = "Patrocinador-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(PatrocinadorResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
